      ...
      <div className="relative z-10 h-full flex flex-col p-4">
        <div className="max-w-6xl mx-auto w-full h-full flex flex-col">
          ...
          <div className="grid lg:grid-cols-2 gap-6 flex-1 min-h-0">
            {/* Create Paste Form */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-6 flex flex-col">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl">
                  <Code2 className="w-4 h-4 text-white" />
                </div>
                <h2 className="text-xl font-bold text-gray-800">Create New Paste</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 flex-1 flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 text-gray-900"
                      min="1"
                      placeholder="Never"
                    />
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-6 rounded-2xl font-semibold hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  {loading ? (
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700 text-sm">Time-based expiry</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Eye className="w-4 h-4 text-purple-500" />
                    <span className="text-gray-700 text-sm">View-based limits</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <ExternalLink className="w-4 h-4 text-pink-500" />
                    <span className="text-gray-700 text-sm">Shareable URLs</span>
                  </div>
                </div>
              </div>
            </div>
